# BIO203 Ch.7 Multiple Choice Questions - Version 3 (Highest Yield)
# 40 questions, all trap-focused, cited to Popa slides + OpenStax
...
OUTPUT = 'C:/Users/User/Dropbox/Nu micro/Ch 7/BIO203_Ch7_MC_Questions_v3.pdf'
...
story.append(Paragraph('BIO203 — Chapter 7 — 40 Multiple Choice Questions — Version 3', h1))
story.append(Paragraph('Microbial Biochemistry | Highest Yield | Answer key included', ParagraphStyle('sub', fontSize=9, fontName='Helvetica-Oblique', spaceAfter=4, alignment=TA_CENTER)))
...
questions = [
    ...
    (1,
     ...
     "B", "Popa Ch.7 slide 19; OpenStax 7.3"),
    ...
    (2,
     ...
     "B", "Popa Ch.7 slide 7; OpenStax 7.2"),
    ...
    (3,
     ...
     ["A. Structural isomers",
      ...
      "D. Epimers"],
     "C", "Popa Ch.7 slide 8; OpenStax 7.1"),
    ...
    (4,
     ...
     ["A. Carbon dioxide (CO2)",
      ...
      "D. A phosphate group"],
     "C", "Popa Ch.7 slide 11; OpenStax 7.1"),
    ...
    (5,
     ...
     "C", "Popa Ch.7 slide 10; OpenStax 7.1"),
    ...
    (6,
     ...
     "B", "Popa Ch.7 slide 10; OpenStax 7.1"),
    ...
    (7,
     ...
     ["A. Cellulose",
      ...
      "D. Glycogen"],
     "C", "Popa Ch.7 slide 17; OpenStax 7.2 — NAM is bacteria-only"),
    ...
    (8,
     ...
     "B", "Popa Ch.7 slide 17; OpenStax 7.2"),
    ...
    (10,
     ...
     "C", "Popa Ch.7 slide 17; OpenStax 7.2"),
    ...
    (11,
     ...
     "B", "Popa Ch.7 slide 16; OpenStax 7.2"),
    ...
    (12,
     ...
     "B", "Popa Ch.7 slide 14; OpenStax 7.2"),
    ...
    (13,
     ...
     "C", "Popa Ch.7 slide 22; OpenStax 7.3"),
    ...
    (14,
     ...
     "B", "Popa Ch.7 slide 22; OpenStax 7.3"),

    (15,
     "Bacteria do NOT produce cholesterol to stabilize their membranes. Instead, bacteria use:",
     ["A. Ergosterol", "B. Hopanoids",
      "C. Wax esters", "D. Triglycerides"],
     "B", "Popa Ch.7 slide 24; OpenStax 7.3"),

    (16,
     "Ergosterol is the membrane sterol found in fungi. This is clinically important because:",
     ["A. Ergosterol causes fungal infections by triggering inflammation",
      "B. Ergosterol is the TARGET of antifungal drugs like fluconazole and amphotericin B",
      "C. Ergosterol is structurally identical to human cholesterol and can replace it",
      "D. Ergosterol makes fungi resistant to Gram staining"],
     "B", "Popa Ch.7 slide 24; OpenStax 7.3"),
    ...
    (17,
     ...
     "B", "Popa Ch.7 slide 25; OpenStax 7.3"),
    ...
    (18,
     ...
     "B", "Popa Ch.7 slide 20; OpenStax 7.3"),
    ...
    (19,
     ...
     "B", "Popa Ch.7 slide 21; OpenStax 7.3"),

    (20,
     "Which organism is mentioned in lecture as accumulating PHB (poly-beta-hydroxybutyrate) granules?",
     ["A. Pseudomonas aeruginosa — it does NOT accumulate PHB",
      "B. Mycobacterium tuberculosis",
      "C. Escherichia coli",
      "D. Bacillus subtilis"],
     "A", "Popa Ch.7 slide 39; OpenStax 7.5 — P. aeruginosa does NOT accumulate PHB"),
    ...
    (21,
     ...
     "C", "Popa Ch.7 slide 31; OpenStax 7.4"),
    ...
    (22,
     ...
     "B", "Popa Ch.7 slide 32; OpenStax 7.4"),
    ...
    (23,
     ...
     "B", "Popa Ch.7 slide 33; OpenStax 7.4 — peptide bonds stabilize PRIMARY structure"),
    ...
    (24,
     ...
     "D", "Popa Ch.7 slide 34; OpenStax 7.4"),
    ...
    (25,
     ...
     "B", "Popa Ch.7 slide 34; OpenStax 7.4"),

    (26,
     "Cystic fibrosis is caused by:",
     ["A. A mutation in the promoter region of the CFTR gene eliminating transcription",
      "B. Loss of a single amino acid (phenylalanine) in the CFTR protein, altering its 3D structure",
      "C. A frameshift mutation that creates a premature stop codon in all CFTR copies",
      "D. Denaturation of CFTR protein by elevated body temperature"],
     "B", "Popa Ch.7 slide 30; OpenStax 7.4"),
    ...
    (27,
     ...
     "B", "Popa Ch.7 slide 35; OpenStax 7.4"),
    ...
    (29,
     ...
     "C", "Popa Ch.7 slide 33; OpenStax 7.4"),
    ...
    (30,
     ...
     "D", "Popa Ch.7 slide 28; OpenStax 7.4"),
    ...
    (31,
     ...
     "B", "Popa Ch.7 slides 44-46; OpenStax 7.5"),
    ...
    (32,
     ...
     "B", "Popa Ch.7 slide 47; OpenStax 7.5"),

    (33,
     "Lancefield grouping of Streptococcus species is based on:",
     ["A. Fatty acid profiles determined by gas chromatography",
      "B. Protein mass spectra from MALDI-TOF analysis",
      "C. Surface carbohydrate antigens detected by antibody agglutination",
      "D. 16S rRNA gene sequencing"],
     "C", "Popa Ch.7 slide 49; OpenStax 7.5"),

    (34,
     "In MALDI-TOF analysis, the specimens are subjected to a UV laser pulse. What does this do?",
     ["A. Kills the microorganism and releases DNA for PCR amplification",
      "B. Generates gaseous ions from proteins and chemicals in the sample; ions are separated by mass-to-charge ratio",
      "C. Excites fluorochrome dyes attached to antibodies",
    ...
    (35,
     ...
     "C", "Popa Ch.7 slide 19; OpenStax 7.3 — most tested trap in Ch.7"),
    ...
    (36,
     ...
     "C", "Popa Ch.7 slide 17 + Ch.1 slide 21; OpenStax 7.2 + 1.3"),
    ...
    (37,
     ...
     "D", "Popa Ch.7 slide 35; OpenStax 7.4"),
    ...
    (38,
     ...
     "B", "Popa Ch.2 slide 28; Ch.7 slide 25; OpenStax 2.4 + 7.3"),
    ...
    (39,
     ...
     "C", "Popa Ch.7 slide 21; OpenStax 7.3"),
...
# Print questions
story.append(Paragraph("Chapter 7 — 40 Questions (Microbial Biochemistry)", h2))
...
story.append(Paragraph('ANSWER KEY — Ch.7 Version 3', h1))
...
story.append(Paragraph(
    'Sources: Popa BIO203 Ch.7 lecture slides (49 slides) + OpenStax Microbiology Ch.7. '
    'Version 3 — 40 questions, highest yield, trap-focused.',
