...
OUTPUT = r'C:/Users/User/Dropbox/Nu micro/chapter 1 and 2/BIO203A_Lab2_Filled_v4.pdf'
...
story.append(Paragraph('Filled-In Report · Version 4 (Lecture Slides Only) · Spring 2026 · Dr. Radu Popa', h2))
...
story.append(tbl([
    ...
    ['Incubation',
     ...
     '25°C = mesophilic soil bacteria. 37°C would select for body-temp organisms instead.'],
...
story.append(Paragraph(
    'Sources: BIO203A Lab 2 (Popa); Tiny Earth manual; Popa Ch.7 lecture slides. Version 4 — lecture-slide content only.',
