...
OUTPUT = r'C:/Users/User/Dropbox/Nu micro/chapter 1 and 2/BIO203A_Lab2_Study_Guide_v4.pdf'
...
story.append(Paragraph('BIO203A — Lab 2 Study Guide: Soil Plating — Version 4 (Lecture Slides Only)', h1))
story.append(Paragraph(
    'Serial Dilutions · CFU Calculations · Colony Morphology · Aseptic Technique · Antibiotic Discovery',
    h2))
story.append(Paragraph('Connections to Ch.7 Biochemistry (lecture slides) noted throughout', note))
story.append(sp(1))
...
story.append(Paragraph('7. Ch.7 Biochemistry Connections (from lecture slides)', h2))
story.append(hr())
story.append(tbl([
    ['Lab observation', 'Ch.7 Biochemistry explanation'],
    ['Why R2A supports soil bacteria better than rich media',
     'Oligotrophic soil bacteria have enzyme systems adapted to low carbohydrate concentrations (Ch.7). Rich media overwhelm them with fast-growing competitors.'],
    ...
    ['Why Actinomycetes colony is chalky/powdery',
     'Aerial hyphae tipped with conidiospores — spore wall contains modified carbohydrates and waxy lipids.'],
    ['Why mucoid colonies look slimy',
     'Slimy = polysaccharide capsule (Ch.7 carbohydrates — exopolysaccharide secreted outside cell wall). Protects against drying.'],
    ['Why saline (NaCl) is used as diluent, not water',
     'Pure water = hypotonic → osmotic shock can lyse cells before plating. Saline maintains osmotic balance. Phospholipid bilayer integrity requires isotonic conditions.'],
    ['Why some colonies are yellow/orange',
     'Carotenoids = isoprenoid lipids (Ch.7 §7.3 — Popa slide 32). Function as pigments and antioxidants — protect against UV in exposed soil.'],
], [2.0*inch, 5.2*inch]))
story.append(sp(2))
