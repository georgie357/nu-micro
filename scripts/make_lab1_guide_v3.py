# BIO203A Lab 1: Microscopy - Study Guide (Version 3 - Highest Yield)
# Added: exam trap column, Popa emphasis flags, highest yield callouts
...
OUTPUT = r"C:\Users\User\Dropbox\Nu micro\chapter 1 and 2\BIO203A_Lab1_Study_Guide_v3.pdf"
...
story += [
    ...
    sp(3),
    Paragraph("Lab 1: Microscopy — Study Guide (Version 3 — Highest Yield)",
              ParagraphStyle('TS', fontName='Helvetica-Bold', fontSize=13, alignment=TA_CENTER)),
    sp(3),
    Paragraph("Source: Lab 1 docx (Popa) + Ch.2 slides (33) + Ch.1 slides (29) + OpenStax Ch.1-2",
...
qs = [
    ...
    ("Which microscope is best for live unstained Paramecium?",
     "Phase-contrast — creates high contrast without staining or killing cells. Darkfield also acceptable (good for motility). DIC (Nomarski) also works. Brightfield shows poor contrast on live unstained organisms."),
...
story.append(Paragraph(
    ...
    "Popa Ch.1 lecture slides (29 slides); OpenStax Microbiology (2016) Ch.1-2. Version 3.", cit))
