# BIO203A Lab 1: Microscopy - Filled Report (Version 3 - Highest Yield)
# Added: exam tip column, Popa emphasis flags, common traps, lecture connections
...
OUTPUT = r"C:\Users\User\Dropbox\Nu micro\chapter 1 and 2\BIO203A_Lab1_Filled_v3.pdf"
...
story += [
    ...
    sp(3),
    Paragraph("Lab 1: Microscopy — Filled Report (Version 3 — Highest Yield)",
              ParagraphStyle('TS', fontName='Helvetica-Bold', fontSize=13, alignment=TA_CENTER)),
    sp(3),
    Paragraph("Based on: Lab 1 docx (Popa) + Ch.2 lecture slides + OpenStax Microbiology 2.1-2.4",
...
story.append(tbl([
    ...
    ["Yeast\n(Saccharomyces)",
     ...
     "Best at 40× (400×); budding visible; Gram-positive like appearance; simple stain with methylene blue useful; ~5-10 µm requires 40× to resolve detail"],
    ["Bacillus subtilis\n(rod bacteria)",
    ...
    ["Size estimation\nfrom FOV",
     ...
     "FOV diameter ÷ number of cells visible = estimated cell size; ocular micrometer gives precise measurement (Ch.2)"],
], [1.3*inch, 2.6*inch, 3.1*inch]))
story.append(sp())

story.append(Paragraph(
    "Sources: BIO203A Lab 1 Microscopy docx (Popa); Popa Ch.2 lecture slides; "
    "Popa Ch.1 lecture slides; OpenStax Microbiology (2016) Ch.1-2. Version 3.", cit))
